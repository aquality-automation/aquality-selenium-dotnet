...
namespace Aquality.Selenium.Tests.Integration
{
    internal class ShadowRootTests : UITest
    {
        ...
        public void Should_ExpandShadowRoot_FromElement()
        {
            ...
            Assert.IsNotNull(form.DownloadsToolbarLabel.FindElementInShadowRoot<ILabel>(form.NestedShadowRootLocator, "More actions menu").GetElement(),
        ...
        public void ShouldBePossibleTo_ExpandShadowRoot_ViaJs()
        {
            ...
            Assert.IsNotNull(form.DownloadsToolbarLabelFromJs.JsActions.FindElementInShadowRoot<ILabel>(form.NestedShadowRootLocator, "More actions menu").GetElement(),
                "Should be possible to expand the nested shadow root and get the element from it");
